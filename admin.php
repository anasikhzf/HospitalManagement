        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol>
                        <li>Admin bisa apa saja :</li>
                        <li>Admin hanya bisa menambah data dokter dan ruang perawatan</li>
                        <li>Untuk data lainnya admin hanya bisa mengupdate dan menghapus</li>
                        <li>Untuk data lainnya juga yang bisa menambahkan hanyalah user sendiri</li>
                    </ol>
