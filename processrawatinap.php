...
$queries = [
    'doctors' => "SELECT * FROM dokter WHERE spesialis = '$poli'",
    'rooms' => "SELECT * FROM ruang_perawatan"
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_query($koneksi, $query2)) {
        ...
        $query4 = "CALL ubah_status_ruang_perawatan('$id_ruang', 'Tidak Tersedia')";
        if (mysqli_query($koneksi, $query4)) {
            ...
            $error = "Error updating room status: " . mysqli_error($koneksi);
        }
    } else {
